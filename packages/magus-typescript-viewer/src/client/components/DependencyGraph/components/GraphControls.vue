...
const emit = defineEmits<{
  ...
  'reset-layout': [];
  'layout-change': [config: { direction?: string; nodeSpacing?: number; layerSpacing?: number }];
...
// Relationship types matching the actual edge data types
...
<template>
  <div class="bg-background-paper p-4 rounded-lg border border-border-default shadow-xl max-w-xs">
    <!-- Button Group -->
    ...
    <div class="mt-4 pt-4 border-t border-border-default">
      ...
      <div class="flex flex-col gap-3">
        ...
        <div>
          <label class="text-xs text-text-secondary block mb-1"> Layer Spacing: {{ layerSpacing }} </label>
          <input
